...
def bat_recode(year):
    ...
    batting_stats_columns = ['IDfg', 'key_mlbam', 'key_bbref', 'Name', 'Team', 'bat_split', 'GB/FB', 'LD%', 'GB%', 'FB%', 'IFFB%', 'HR/FB', 'Spd', 'BsR', 'wFB/C', 'wSL/C', 'wCT/C', 'wCB/C', 'wCH/C', 'wSF/C', 'O-Swing%', 'Z-Swing%', 'Swing%', 
        'O-Contact%', 'Z-Contact%', 'Contact%', 'Zone%', 'F-Strike%', 'SwStr%', 'Pull%', 'Cent%', 'Oppo%', 'Soft%', 'Med%', 'Hard%', 'wFA/C (sc)', 'wFC/C (sc)', 'wFS/C (sc)', 
        'wFO/C (sc)', 'wSI/C (sc)', 'wSL/C (sc)', 'wCU/C (sc)', 'wKC/C (sc)', 'wCH/C (sc)', 'O-Swing% (sc)', 'Z-Swing% (sc)', 'Swing% (sc)', 'O-Contact% (sc)',
        'Z-Contact% (sc)', 'Contact% (sc)', 'Zone% (sc)', 'LD+%', 'GB%+' ,'FB%+', 'HR/FB%+', 'Pull%+', 'Cent%+', 'Oppo%+', 'Soft%+', 'Med%+', 'Hard%+', 'EV', 'LA', 'Barrel%', 'maxEV', 
        'HardHit%', 'CStr%', 'CSW%', 'wCH/C (pi)', 'wCU/C (pi)', 'wFA/C (pi)', 'wFC/C (pi)', 'wFS/C (pi)', 'wSI/C (pi)', 'wSL/C (pi)', 'O-Swing% (pi)', 
...
def pitch_recode(year):
    ...
    pitching_stats_columns = ['IDfg', 'key_mlbam', 'key_bbref', 'Name', 'Team', 'pitch_split', 'GB/FB', 'LD%', 'GB%', 'FB%', 'IFFB%', 'HR/FB', 'FB% 2', 'FBv', 'SL%', 'SLv', 'CT%', 'CTv', 'CB%', 'CBv', 'CH%', 'CHv', 'SF%', 'SFv', 'wFB/C', 'wSL/C', 
    'wCT/C', 'wCB/C', 'wCH/C', 'wSF/C', 'O-Swing%', 'Z-Swing%', 'Swing%', 'O-Contact%', 'Z-Contact%', 'Contact%', 'Zone%', 'F-Strike%', 'SwStr%', 'FA% (sc)', 
    'FC% (sc)', 'FS% (sc)', 'FO% (sc)', 'SI% (sc)', 'SL% (sc)', 'CU% (sc)', 'KC% (sc)', 'CH% (sc)', 'vFA (sc)', 'vFC (sc)', 'vFS (sc)', 'vFO (sc)', 
    'vSI (sc)', 'vSL (sc)', 'vCU (sc)', 'vKC (sc)', 'vCH (sc)', 'vKN (sc)', 'FA-X (sc)', 'FC-X (sc)', 'FS-X (sc)', 'FO-X (sc)', 'SI-X (sc)', 'SL-X (sc)', 'CU-X (sc)', 'KC-X (sc)', 
    'CH-X (sc)', 'FA-Z (sc)', 'FC-Z (sc)', 'FS-Z (sc)', 'FO-Z (sc)', 'SI-Z (sc)', 'SL-Z (sc)', 'CU-Z (sc)', 'KC-Z (sc)', 'CH-Z (sc)',
 'wFA/C (sc)', 'wFC/C (sc)', 'wFS/C (sc)', 'wFO/C (sc)', 'wSI/C (sc)', 'wSL/C (sc)', 'wCU/C (sc)', 'wKC/C (sc)', 'wCH/C (sc)',
    'O-Swing% (sc)', 'Z-Swing% (sc)', 'Swing% (sc)', 'O-Contact% (sc)', 'Z-Contact% (sc)', 'Contact% (sc)', 'Zone% (sc)', 'LD%+', 'GB%+', 'FB%+', 'HR/FB%+', 'Pull%+', 'Cent%+', 
    'Oppo%+', 'Soft%+', 'Med%+', 'Hard%+', 'EV', 'LA', 'Barrel%', 'maxEV', 'HardHit%', 'CStr%', 'CSW%', 'CH% (pi)', 'CU% (pi)', 'FA% (pi)', 'FC% (pi)', 'FS% (pi)', 'SI% (pi)', 'SL% (pi)', 'vCH (pi)', 
    'vCU (pi)', 'vFA (pi)', 'vFC (pi)', 'vFS (pi)', 'vSI (pi)', 'vSL (pi)', 'CH-X (pi)', 'CU-X (pi)', 'FA-X (pi)', 'FC-X (pi)', 'FS-X (pi)', 
    'SI-X (pi)', 'SL-X (pi)', 'CH-Z (pi)', 'CU-Z (pi)', 'FA-Z (pi)', 'FC-Z (pi)', 'FS-Z (pi)', 'SI-Z (pi)', 'SL-Z (pi)', 'wCH/C (pi)', 'wCU/C (pi)', 
    'wFA/C (pi)', 'wFC/C (pi)', 'wFS/C (pi)', 'wSI/C (pi)', 'wSL/C (pi)', 'O-Swing% (pi)', 'Z-Swing% (pi)', 'Swing% (pi)', 'O-Contact% (pi)', 'Z-Contact% (pi)', 
...
def fielding_recode(year, home_away):
    ...
    # 나눌 지표들 리스트
    metrics = ['ARM', 'DPR', 'RngR', 'ErrR', 'UZR', 'Def', 'FRM', 'OAA', 'Range']
...
def gamelog_agg(year):
    ...
    with pd.ExcelWriter('data/gamelog_agg_' + str(year) + '.xlsx', engine='xlsxwriter') as writer:
...
if __name__ == '__main__':
    ...
    gamelog_all.to_pickle('data/gamelog_agg.pkl')
