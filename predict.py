...
def today_lineup(bat_recode, pitch_recode, home_fielding_recode, away_fielding_recode, year, date):
    """
    ...
    for match in match_data:
        try:
            ...
            for i in range(9):
                ...
                away_batter_num = int(list(match.find_all(attrs={'class':'starting-lineups__player--link'})[i].attrs.values())[1][-6:])
            ...
            model_path = 'model/mlb_model_dnn_5.hdf5'
            ...
            home_expRuns = teamExpectedRuns(home_team, away_team, home_batter_away_starter_lineup_list, home_batter_away_relief_lineup_list, starter_data, away_start_pitcher, away_start_pitcher_num)
            away_expRuns = teamExpectedRuns(away_team, home_team, away_batter_home_starter_lineup_list, away_batter_home_relief_lineup_list, starter_data, home_start_pitcher, home_start_pitcher_num)
...
if __name__ == '__main__':
    ...
    results = today_lineup(bat_recode, pitch_recode, home_fielding_recode, away_fielding_recode, 2024, '2024-07-06')
